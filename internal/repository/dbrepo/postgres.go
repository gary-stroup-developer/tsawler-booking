...
func (m *postgresDBRepo) InsertReservation(res models.Reservation) (int, error) {
	// context is available anywhere in application. Introduced around Go 1.18
	// if this insertion transaction takes longer than 3 seconds, something is wrong with our application
	...
	// ignore the result returned from the execution of the insertion
